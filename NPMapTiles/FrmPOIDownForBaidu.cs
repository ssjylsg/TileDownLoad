...
namespace NPMapTiles
{
    ...
    public partial class FrmPOIDownForBaidu : Office2007Form
    {
        ...
        private ILog log;
        public FrmPOIDownForBaidu(Extent extent)
        {
            InitializeComponent();
            this.extent = extent;
        ...
        private void InitDataTable()
        {
            ...
            DataColumn dc = null;
            dc = this.dataTable.Columns.Add("name", Type.GetType("System.String"));
            dc = this.dataTable.Columns.Add("X", Type.GetType("System.String"));
            dc = this.dataTable.Columns.Add("Y", Type.GetType("System.String"));
          
            dc = this.dataTable.Columns.Add("r_addr", Type.GetType("System.String"));
            dc = this.dataTable.Columns.Add("type", Type.GetType("System.String"));
            dc = this.dataTable.Columns.Add("phone", Type.GetType("System.String"));
        }
        int k = 0;
