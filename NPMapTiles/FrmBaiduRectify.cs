...
{
    public partial class FrmBaiduRectify : Office2007Form
    {
        private string path = "";
        ...
        private void converteData()
        {
            ...
            foreach (DataRow row in tempDataTable.Rows)
            {
                if (!this.isStop)
                {
                    ...
                    coord = CoordHelper.BdDecrypt(coord.lat, coord.lon);
                    ...
                    {
                        newRow[tempDataTable.Columns[i].ColumnName] = row[tempDataTable.Columns[i].ColumnName];
                    }
