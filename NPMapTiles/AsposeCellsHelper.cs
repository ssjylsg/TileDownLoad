    ...
    public class AsposeCellsHelper
    {
        ...
        public static void DownloadExcel(string fileName)
        {
            ...
            if (fil.Exists)
            {
                ...
                System.Web.HttpContext.Current.Response.AddHeader("content-disposition", "attachment;   filename=" + System.Web.HttpUtility.UrlEncode((fil.Name), System.Text.Encoding.UTF8));
                System.Web.HttpContext.Current.Response.AddHeader("content-length", fil.Length.ToString());
                System.Web.HttpContext.Current.Response.ContentType = "application/octet-stream";

                System.Web.HttpContext.Current.Response.WriteFile(fil.FullName);
